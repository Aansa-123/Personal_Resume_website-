...
const downloadResume = async () => {
  try {
    const url =
      "https://drive.google.com/uc?export=download&id=1gpdB3QttgvRy319c_qa23aDB71WRDtMN";
...
const experiences = [
  {
    ...
    description:
      "Currently pursuing degree with focus on full-stack development",
  },
  {
    icon: Briefcase,
      ...
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              MERN Stack Engineer pursuing a BS in Information Technology. I
              build full-stack applications — from database schema to deployed
              infrastructure — with a strong focus on security, performance, and
              clean code.
            </motion.p>
